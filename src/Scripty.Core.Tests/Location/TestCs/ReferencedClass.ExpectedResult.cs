...
using Scripty;using Scripty.Core;using Scripty.Core.Tests;using Scripty.Core.Tests.TestCs;

    using System.Data;

    /// <summary>
    ///     This example class is for testing the <see cref="Resolvers.CsFileRewriter"/>
    /// </summary>
